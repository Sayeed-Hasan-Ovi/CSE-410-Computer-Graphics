...
GLfloat upx = 0, upy = 1, upz = 0;              //up . look != 0
...
void drawCylinder() {
    ...
    for (int theta = 0; theta < 360; theta++) {
        GLdouble x1 = r * cos(theta * M_PI/180.0);
        GLdouble y1 = r * sin(theta * M_PI/180.0);

        GLdouble x2 = r * cos((theta+1) * M_PI/180.0);
        GLdouble y2 = r * sin((theta+1) * M_PI/180.0);
        glBegin(GL_QUADS);
