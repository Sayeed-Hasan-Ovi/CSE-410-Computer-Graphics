...
class Object
{
    ...
    double intersect(Ray& ray, Color& pixelColor, int recursionLevel) {
        ...
        for(int i = 0; i < lights.size(); i++) {
            ...
            lightRay.origin = lightRay.origin + lightRay.dir * epsilon;
        ...
        for(int i = 0; i < spotLights.size(); i++) {
            ...
            Vector spotLightLookDir = spotLights[i].lookDir - spotLightPos;
            spotLightLookDir.normalize();
            double angle = acos(spotLightDir * spotLightLookDir * (-1.0)) * 180.0 / M_PI;

            if(angle > spotLights[i].cutoffAngle - epsilon) {
                continue;
            }
            
            Ray spotLightRay(intersectionPoint, spotLightDir);
            //spotLightRay.origin = spotLightRay.origin + spotLightRay.dir * epsilon;
        ...
        ////reflection code
            ...
            Ray reflectedRay(intersectionPoint, ray.dir - 
            ...
            if(nearestObjectIndex != -1) {
                ...
                double t = objects[nearestObjectIndex]->intersect(reflectedRay, tempColor, recursionLevel - 1);
                cout << "reflectionCoeff "<< reflectionCoeff <<endl;
                cout << " tempColor "<<tempColor.r << " " << tempColor.g << " " << tempColor.b <<endl;
...
class CheckerBoard : public Object
{
    ...
    bitmap_image blackTexture;
    bitmap_image whiteTexture;
    CheckerBoard(){}
